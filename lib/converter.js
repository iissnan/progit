...
Converter.prototype.generateChapters = function () {
    ...
    function generatePages(chapterRawContent, index) {
        ...
        function getPageSidebar() {
            ...
            return '<ul class="nav sub-nav">' +
                       '<li class="nav-header"><a href="ch' + index + '_0.html">' + h1 + '</a></li>' +
                       sectionItems +
                   '</ul>';
        }
...
Converter.prototype.getFooter = function () {
    ...
    return  buildDate + getLabel("symbol", "comma") + buildSourceRevision + getLabel("symbol", "period");
