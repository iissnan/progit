...
Converter.prototype.getFooter = function () {
    return "Build at: " + this.getBuildDate() + ". Source Revision: " + this.getBuildSourceRevision() + ".";
};
...
Converter.prototype.getMenu = function (level) {
    ...
    function getAboutLink(translation) {
        ...
        return linkCompiler({
            link: link,
            text: I18N.menu[translation] ? I18N.menu[translation]["aboutLabel"] : I18N.menu[CONFIG.defaultTranslation]["aboutLabel"]
        });
    }
};
